...
1. **Generate** a manifest for your app (manually, or with a tool like [BridgeAI](https://bridgeai.app)).
...
[BridgeAI](https://bridgeai.app) — the governance layer for the agent economy.
